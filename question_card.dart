import 'dart:ui';
import 'package:estfsar_app/home_screen.dart';
...
class QuestionCard extends StatefulWidget {
  ...
  final String category; // 🌟 1. تم تعريف متغير الفئة بشكل صحيح هنا داخل الكلاس

  const QuestionCard(
    this.document, {
    // 🌟 2. جعلنا المعامل الأول الموقعي يستقبل المستند مباشرة ليتوافق مع الشاشات الأخرى
    Key? key,
    required this.docId,
    ...
    required fs.DocumentSnapshot<Object?>
        document, // 🌟 3. تم ربط الفئة بالـ Constructor بشكل صحيح
  }) : super(key: key);
...
late final String category; // 👈 أضف هذا السطر لاستقبال الفئة
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: NetworkImage(
                          // 🌟 استبدال الرابط الثابت بالمتغير الديناميكي الذي يجلب الصورة بناءً على الفئة
                          categoryImages[widget.category] ??
                              categoryImages['الافتراضية']!,
                        ),
                        fit: BoxFit.cover,
                        // 🌟 الفلتر السحري: يجعل الصورة الخلفية هادئة وشفافة جداً لتبرز النصوص فوقها
